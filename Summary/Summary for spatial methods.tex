...
\textcolor[rgb]{1.00,0.00,1.00}{Comment:} Two obvious advantages are parallel computing and capturing spatial dependencies at different scales.
...
\begin{equation}
\begin{aligned}
  \boldsymbol{\Sigma}(\cdot; \boldsymbol{\theta})^{-1} = & \boldsymbol{A}^{-1} - \boldsymbol{A}^{-1}\boldsymbol{H}^\prime 
...
\begin{equation}
\begin{aligned}
  \text{det}\{\boldsymbol{\Sigma}\} = &  \text{det}\{\boldsymbol{\tilde{C}}_2^{-1} + + \boldsymbol{H}^\prime\boldsymbol{A}^{-1}\boldsymbol{H}\}\text{det}\{\boldsymbol{\tilde{C}}_2^{-1}\}^{-1}\text{det}\{\boldsymbol{A}\}
\end{aligned}
\end{equation}
