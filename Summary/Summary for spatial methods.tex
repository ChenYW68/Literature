...
\begin{equation}
\begin{aligned}
w(s) = \boldsymbol{d}^\prime(s) \boldsymbol{w}^{\star} \label{Sm1}
\end{aligned}
\end{equation}
and
\begin{equation}
...
\mathcal{G}\left(s; \boldsymbol{c}_{s, N(s)}^\prime \boldsymbol{C}_{N(s)}^{-1}\right), \text{ otherwise }
\end{aligned}
\right.\label{Sm3}
\end{equation}
...
\end{equation}
where $\boldsymbol{D} = \left(\boldsymbol{d}^\prime(1), \dots, \boldsymbol{d}^\prime(n)\right)^\prime$ and $\boldsymbol{H} = \left(\boldsymbol{h}^\prime(1), \dots, \boldsymbol{h}^\prime(n)\right)^\prime$. And according to the assumptions previously mentioned in the model, we know that
\begin{equation}
\begin{aligned}
\boldsymbol{y} \sim GP\left(\boldsymbol{0}, \boldsymbol{\Sigma}(\cdot; \boldsymbol{\theta})\right)
